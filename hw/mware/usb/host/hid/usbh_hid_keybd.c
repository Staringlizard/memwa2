...
static  const  int8_t  HID_KEYBRD_Key[] = {
  '\0', '`',  '1',  '2',  '3',  '4',  '5',  '6', /* 0x00-0x07 */
  '7',  '8',  '9',  '0',  '-',  '=',  '\0', '\r', /* 0x08-0xF */
  '\t', 'q',  'w',  'e',  'r',  't',  'y',  'u', /* 0x10-0x17 */
  'i',  'o',  'p',  '[',  ']',  '\\', '\0', 'a', /* 0x18-0x1F */
  ...
  '\r', '\0', '\0', '\0', '\0', '\0', '\0', '\0', /* 0x50-0x57 */
  '\0', '\0', '\0', '7',  '4',  '1',  '\0', '/', /* 0x58-0x5F */
  '8',  '5',  '2',  '0',  '*',  '9',  '6',  '3', /* 0x60-0x67 */
  '.',  '-',  '+',  '\0', '\n', '\0', 0x1B, '\0', /* 0x68-0x6F */
...
/**
  ...
  * @retval ASCII code
  */
uint8_t USBH_HID_GetASCIICode(uint8_t key)
{
  uint8_t output;
  output = HID_KEYBRD_Key[HID_KEYBRD_Codes[key]];
  return output;
}
...
uint8_t USBH_HID_ShiftPressed(HID_KEYBD_Info_TypeDef *info)
{
  if((info->lshift == 1) || (info->rshift == 1))
  {
    return 1;
  }
  else
...
uint8_t USBH_HID_CtrlPressed(HID_KEYBD_Info_TypeDef *info)
{
  if((info->lctrl == 1) || (info->rctrl == 1))
  {
    return 1;
  }
  else
