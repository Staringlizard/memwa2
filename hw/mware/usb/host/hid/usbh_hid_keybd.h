...
uint8_t USBH_HID_GetASCIICode(uint8_t key); /* Changed by Memwa2 */
uint8_t USBH_HID_GetKeyCode(HID_KEYBD_Info_TypeDef *info); /* Added by Memwa2 */
uint8_t USBH_HID_ShiftPressed(HID_KEYBD_Info_TypeDef *info); /* Added by Memwa2 */
uint8_t USBH_HID_CtrlPressed(HID_KEYBD_Info_TypeDef *info); /* Added by Memwa2 */
